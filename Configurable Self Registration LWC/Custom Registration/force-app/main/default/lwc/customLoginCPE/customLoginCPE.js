...
export default class CustomLogin extends LightningElement {
  ...
  handleSignUpClick(event) {
    ...
    this.configurationOptions["blockUserErrorMessage"] =
      this.blockUserErrorMessage;
    this.configurationOptions["userLockedOutErrorMessage"] =
      this.userLockedOutErrorMessage;
    this.configurationOptions["incorrectUserCredentialsErrorMessage"] =
      this.incorrectUserCredentialsErrorMessage;
    this.configurationOptions["failedCodeVerificationMessage"] =
      this.failedCodeVerificationMessage;
    this.configurationOptions["portalLoginRedirect"] = this.portalLoginRedirect;
    this.configurationOptions["enablePasswordlessLogin"] =
      this.enablePasswordlessLogin;
      ...
      if (this.enablePasswordlessLogin && this.showVerificationCode) {
        ...
        verifyUser({
          ...
          .catch((error) => {
            this.handleSubmit(
              false,
              this.loginButtonAwaitingCodeMessage,
              false
            );
        ...
        loginUser({
          ...
          .then((result) => {
            ...
            this.showVerificationCode =
              this.loginResults.loginResult[0].showVerificationCode;
            ...
            if (this.showVerificationCode) {
              ...
              ).value = this.loginResults.loginResult[0].verificationId; //Dynamically set the value of the Verification Id field.
              this.template
